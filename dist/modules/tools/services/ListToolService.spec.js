...
var ListToolService_1 = __importDefault(require("./ListToolService"));
var fakeToolsRepository;
var listToolService;
describe('ListToll', function () {
    beforeEach(function () {
        fakeToolsRepository = new FakeToolsRepository_1.default();
        listToolService = new ListToolService_1.default(fakeToolsRepository);
    });
